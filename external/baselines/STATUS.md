...
| SASNet | Official external repository adaptation | Medium | Yes | Pinned and audited | Vendor snapshot lives in `external/baselines/sasnet/upstream/`; upstream `main@3e2b78a6c6ebe761c5be6a9181457daad6df666d`; continue to local adaptation planning |
...
- Pin date: `2026-04-04`
- Storage model: vendored snapshot under `external/baselines/sasnet/upstream/` with upstream `.git` removed
- Current stage: pinned, first-pass audit captured, local adaptation planning approved
